...
lazy_static! {
    pub static ref APP_ADDRESS: String = set_app_address();
...
fn set_app_address() -> String {
    dotenv().ok();
    std_env::var(env::APP_ADDRESS_ENV_VAR).unwrap_or(prod::APP_ADDRESS.to_owned())
}
...
pub mod env {
    pub const APP_ADDRESS_ENV_VAR: &str = "APP_ADDRESS";
...
pub mod prod {
    ...
    pub mod email_client {
        ...
        pub const SENDER: &str = "rg@viola.pl";
